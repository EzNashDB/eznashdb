...
class FilterHelpTexts:
    FEMALE_LEADERSHIP = "Is there at least one woman in a leadership position"
    CHILDCARE = "Is there an on-site childcare program"
    KADDISH = "Can women say kaddish (includes shuls where a man always says kaddish)"
